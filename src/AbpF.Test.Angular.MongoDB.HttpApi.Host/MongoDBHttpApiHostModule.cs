...
[DependsOn(
    ...
    typeof(MongoDBApplicationModule), //* 因为没有使用 ABP Framework 项目自带的功能，所以不使用
...
public class MongoDBHttpApiHostModule : AbpModule
{
    /// <summary>
    ...
    private void ConfigureAuthenticationTest1(ServiceConfigurationContext context, IConfiguration configuration)
    {
        ...
        context.Services.AddTransient<IAdminAppService, AdminAppService>();
    }
